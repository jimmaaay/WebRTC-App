...
class App extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.sendNotifications && document.hidden) toggleShowNotification(true);

    document.addEventListener('visibilitychange', () => {
      if (this.props.sendNotifications === false) return;
  ...
  notificationButton() {
    ...
    const classNames = ['header__notification'];
    if (sendNotifications) classNames.push('header__notification--granted');
